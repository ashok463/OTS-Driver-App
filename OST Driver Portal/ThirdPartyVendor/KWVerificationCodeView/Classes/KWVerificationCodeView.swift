...
//    didSet {
//      if let font = UIFont(name: FontName.steagalRegular, size: textSize) {
//        textFieldFont = font
//      } else {
//        textFieldFont = UIFont(name: FontName.steagalRegular, size: textSize)!//UIFont.systemFont(ofSize: textSize)
//      }
//
//      for textFieldView in textFieldViews {
