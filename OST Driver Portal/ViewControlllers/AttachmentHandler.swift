...
class AttachmentHandler : NSObject{
    ...
    var imagePickerBlock : ((UIImage, String) -> Void)?
...
//                var minimumSize: CGSize = CGSize(width: 80, height: 80)
...
//
//                    if image == nil{
//                        if let imageBlock = self?.imagePickerBlock{
...
//                present(scannerViewController, animated: true)
                self.currentVC?.present(scannerViewController, animated: true, completion: nil)
            }
        }
    }
...
//                self.currentVC?.present(myPickerController, animated: true, completion: nil)
                ...
                self.currentVC?.present(libraryViewController, animated: true, completion: nil)
            }
//        }
    }
...
extension AttachmentHandler: ImageScannerControllerDelegate{
    ...
    func imageScannerController(_ scanner: ImageScannerController, didFinishScanningWithResults results: ImageScannerResults) {
        ...
        if let imageBlock = imagePickerBlock{
            let imageName = "\(Date().timeIntervalSince1970).jpeg"
            imageBlock(results.croppedScan.image, imageName)
        }
